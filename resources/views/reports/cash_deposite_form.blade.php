...
@section('title', 'Cash Handover Report')

@section('content')
<form autocomplete=off method="GET" action="{{ route('reports.cash_deposite_report') }}" target="_blank">
    @csrf
  <div class="row">
    <div class="col-md-12">
        <div class="card">
            <h5 class="card-header">Cash Handover Report</h5>
            <div class="card-body">
                <div class="row">
