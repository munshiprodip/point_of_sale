    ...
    @foreach($employees as $employee)
        ...
        <table class="collapse-table" >
            ...
            @foreach($employee->daily_attendances as $attendance)
                ...
                @endforeach
                <tr>
                    <td colspan=9>Total: {{$j}} days, Day off: {{$day_off_count}} days, Working day: {{$working_day_count}} days, Present: {{$present_count}} days, Absent: {{$absent_count}} days, Late in: {{$late_in_count}} days, Early leave: {{$early_out_count}} days,</td>
                </tr>
        </table>
        <br>
    @endforeach
